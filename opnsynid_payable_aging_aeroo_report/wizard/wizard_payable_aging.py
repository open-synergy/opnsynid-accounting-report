...
class WizardReportPayableAging(models.TransientModel):
    _name = 'account.wizard_report_payable_aging'
    _description = 'Wizard Report Payable Aging'
    ...
    def button_print_report(self):
        ...
        if datas['form']['output_format'] == 'xls':
            output_format = 'report_payable_aging_xls'
        elif datas['form']['output_format'] == 'ods':
            output_format = 'report_payable_aging_ods'
