...
class WizardReportTrialBalance(osv.osv_memory):
    ...
    def default_company_id(self, cr, uid, context=None):  # pylint: disable=R8110
    ...
    def default_fiscalyear_id(self, cr, uid, context=None):  # pylint: disable=R8110
    ...
    def default_period_id(self, cr, uid, context=None):  # pylint: disable=R8110
    ...
    def default_state(self, cr, uid, context=None):  # pylint: disable=R8110
        return "posted"

    def default_output(self, cr, uid, context=None):  # pylint: disable=R8110
        return "ods"

    _columns = {  # pylint: disable=W8105
        "company_id": fields.many2one(
            string="Company", obj="res.company", required=True
        ),
        "fiscalyear_id": fields.many2one(
            string="Fiscal Year", obj="account.fiscalyear", required=True
        ),
        "period_id": fields.many2one(
            string="Period", obj="account.period", required=True
        ),
    ...
    _defaults = {  # pylint: disable=W8105
